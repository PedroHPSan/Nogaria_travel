...
begin
  ...
  from (values
    ...
    ('2026-09-14', '14:20', '14:40', 'Orlando', 'The Amazing Adventures of Spider-Man', 'park', 'Simulador 3D sobre trilho — a atração forte de maior alcance do dia, e a primeira em que os 4 andam juntos.', 'Universal''s Islands of Adventure', 'planned', 102, true, 'Bloco de agora. Saiu da frente do Hulk e do Doctor Doom para o lugar deles: a família chegou ao Marvel e foi direto nas duas que barram a Gabi, então o Homem-Aranha vira a recompensa dela logo depois das duas trocas seguidas. Ainda dentro do Marvel — nenhuma caminhada extra.', 'Universal''s Islands of Adventure', 'Marvel Super Hero Island', 9, 'attraction', 'S', 'express', 3, false, false, null, false, 'operating', true, null, true, null, null, null, false, 0),
