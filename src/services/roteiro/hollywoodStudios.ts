...
const ROWS: RoteiroRow[] = [
  [1, 'Slinky Dog Dash', 'Toy Story Land', 'attraction', 'S', { minHeightCm: 97, lightningLane: 'genie_plus', lightningLaneRank: 1 }],
  [2, 'Toy Story Mania!', 'Toy Story Land', 'attraction', 'A', { lightningLane: 'genie_plus', lightningLaneRank: 4 }],
  [3, 'Alien Swirling Saucers', 'Toy Story Land', 'attraction', 'B', { minHeightCm: 81, lightningLane: 'genie_plus', lightningLaneRank: 6 }],
  [4, 'Star Wars: Rise of the Resistance', "Galaxy's Edge", 'attraction', 'S', { minHeightCm: 102, description: 'Estratégia própria conforme o produto de fila disponível.' }],
  [5, 'Millennium Falcon: Smugglers Run', "Galaxy's Edge", 'attraction', 'S', { minHeightCm: 97, lightningLane: 'genie_plus', lightningLaneRank: 5 }],
  [6, "Exploração de Galaxy's Edge e Datapad", "Galaxy's Edge", 'experience', 'B'],
  [7, 'Star Tours – The Adventures Continue', 'Grand Avenue e Echo Lake', 'attraction', 'A', { minHeightCm: 102 }],
  ...
  [13, 'The Twilight Zone Tower of Terror', 'Sunset Boulevard', 'attraction', 'S', { minHeightCm: 102, lightningLane: 'genie_plus', lightningLaneRank: 3 }],
  [14, "Rock 'n' Roller Coaster Starring The Muppets", 'Sunset Boulevard', 'attraction', 'S', { minHeightCm: 122 }],
