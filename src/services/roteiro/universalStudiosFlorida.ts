...
const ROWS: RoteiroRow[] = [
  ...
  [6, 'Race Through New York Starring Jimmy Fallon', 'New York', 'attraction', 'B', { minHeightCm: 102 }],
  [7, 'Fast & Furious – Supercharged', 'San Francisco', 'attraction', 'C', { minHeightCm: 102 }],
  [8, 'Beat Builders', 'San Francisco', 'show', undefined, { showDurationMin: 15, description: 'Se programado no dia.' }],
  [9, 'Harry Potter and the Escape from Gringotts', 'Diagon Alley', 'attraction', 'S', { minHeightCm: 107, lightningLane: 'express', lightningLaneRank: 1 }],
  ...
  [15, 'MEN IN BLACK Alien Attack', 'World Expo', 'attraction', 'A', { minHeightCm: 107, lightningLane: 'express', lightningLaneRank: 5 }],
  [16, 'The Simpsons Ride', 'Springfield', 'attraction', 'A', { minHeightCm: 102, lightningLane: 'express', lightningLaneRank: 3 }],
  [17, "Kang & Kodos' Twirl 'n' Hurl", 'Springfield', 'attraction', 'B', { minHeightCm: 91 }],
  [18, 'Exploração de Springfield', 'Springfield', 'experience', 'B'],
  [19, 'Trolls Trollercoaster', 'DreamWorks Land', 'attraction', 'B', { minHeightCm: 91 }],
  ...
  [24, 'E.T. Adventure', 'Hollywood', 'attraction', 'A', { minHeightCm: 86, lightningLane: 'express', lightningLaneRank: 6 }],
