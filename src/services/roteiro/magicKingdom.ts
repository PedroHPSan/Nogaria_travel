...
const ROWS: RoteiroRow[] = [
  [1, 'Seven Dwarfs Mine Train', 'Fantasyland', 'attraction', 'S', { minHeightCm: 97, lightningLane: 'individual' }],
  ...
  [9, 'The Barnstormer', 'Storybook Circus', 'attraction', 'B', { minHeightCm: 89 }],
  ...
  [15, 'Tomorrowland Speedway', 'Tomorrowland', 'attraction', 'B', { minHeightCm: 81 }],
  [16, 'TRON Lightcycle / Run', 'Tomorrowland', 'attraction', 'S', { minHeightCm: 122, lightningLane: 'individual' }],
  [17, 'Space Mountain', 'Tomorrowland', 'attraction', 'S', { minHeightCm: 112, lightningLane: 'genie_plus', lightningLaneRank: 4 }],
  ...
  [26, "Tiana's Bayou Adventure", 'Frontierland', 'attraction', 'S', { minHeightCm: 102, lightningLane: 'genie_plus', lightningLaneRank: 1 }],
  [27, 'Big Thunder Mountain Railroad', 'Frontierland', 'attraction', 'S', { minHeightCm: 102 }],
