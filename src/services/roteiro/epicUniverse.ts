...
const ROWS: RoteiroRow[] = [
  [1, 'Harry Potter and the Battle at the Ministry', 'Ministry of Magic', 'attraction', 'S', { minHeightCm: 102, lightningLane: 'express', lightningLaneRank: 1, description: 'Se a fila estiver muito alta, comparar: entrar já, aguardar queda, usar Express (se aceito) ou retornar antes do fechamento da fila.' }],
  [2, "Mario Kart: Bowser's Challenge", 'Super Nintendo World', 'attraction', 'S', { minHeightCm: 102, lightningLane: 'express', lightningLaneRank: 4 }],
  [3, 'Mine-Cart Madness', 'Super Nintendo World', 'attraction', 'S', { minHeightCm: 122, lightningLane: 'express', lightningLaneRank: 2 }],
  [4, "Yoshi's Adventure", 'Super Nintendo World', 'attraction', 'A', { minHeightCm: 86 }],
  ...
  [8, 'Monsters Unchained: The Frankenstein Experiment', 'Dark Universe', 'attraction', 'S', { minHeightCm: 122, lightningLane: 'express', lightningLaneRank: 3 }],
  [9, 'Curse of the Werewolf', 'Dark Universe', 'attraction', 'A', { minHeightCm: 122, lightningLane: 'express', lightningLaneRank: 7 }],
  ...
  [15, "Hiccup's Wing Gliders", 'Isle of Berk', 'attraction', 'S', { minHeightCm: 102, lightningLane: 'express', lightningLaneRank: 5 }],
  [16, "Dragon Racer's Rally", 'Isle of Berk', 'attraction', 'A', { minHeightCm: 122 }],
  ...
  [21, 'Stardust Racers', 'Celestial Park', 'attraction', 'S', { minHeightCm: 122, lightningLane: 'express', lightningLaneRank: 6 }],
