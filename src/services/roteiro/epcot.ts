...
const ROWS: RoteiroRow[] = [
  ...
  [22, 'Reflections of China', 'China', 'show', 'B', { showDurationMin: 20 }],
  [23, 'Exploração da Alemanha', 'Alemanha', 'experience', 'C'],
  [24, 'Exploração da Itália', 'Itália', 'experience', 'C'],
  [25, 'The American Adventure', 'Estados Unidos', 'show', 'A', { showDurationMin: 29 }],
  [26, 'Voices of Liberty', 'Estados Unidos', 'show', undefined, { showDurationMin: 15 }],
  ...
  [30, 'Beauty and the Beast Sing-Along', 'França', 'show', 'B', { showDurationMin: 25 }],
  [31, 'Exploração do Reino Unido', 'Reino Unido', 'experience', 'C'],
  [32, 'Canada Far and Wide in Circle-Vision 360', 'Canadá', 'show', 'B', { showDurationMin: 18 }],
  [33, 'Luminous: The Symphony of Us', 'Encerramento', 'show', undefined, { lastShowtimeOfDay: true, showDurationMin: 18, description: 'Conforme programação oficial da data.' }],
];
