    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Nome do Programa *</label>
            <input
              type="text"
              required
              value={programName}
          ...
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Titular da Conta *</label>
            <select
              required
              value={holderId}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Saldo de Milhas / Pontos *</label>
            <input
              type="number"
              required
              min="0"
          ...
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Custo por 1.000 Milhas (CPM em US$)</label>
            <input
              type="number"
              min="0"
              step="0.01"
        ...
        <div className="p-3 rounded-xl bg-ink-950/60 border border-ink-800 flex items-center justify-between text-ink-300 font-medium">
          ...
          <span className="font-bold text-success-400 text-sm">US$ {cashEquiv.toFixed(2)}</span>
        </div>
