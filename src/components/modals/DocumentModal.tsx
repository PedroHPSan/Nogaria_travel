  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        ...
        <div>
          <label className="block text-ink-300 font-semibold mb-1">Título do Documento *</label>
          <input
            type="text"
            required
            value={title}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Categoria do Arquivo</label>
            <select
              value={category}
          ...
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Link do Arquivo (PDF / Imagem)</label>
            <input
              type="text"
              value={fileUrl}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Vincular a Participante (Opcional)</label>
            <select
          ...
          <div>
            <label className="block text-ink-300 font-semibold mb-1">Tamanho Estimado</label>
            <input
              type="text"
              value={fileSize}
        ...
        <div>
          <label className="block text-ink-300 font-semibold mb-1">Observações & Leitura IA</label>
          <textarea
            rows={3}
            value={notes}
        ...
        <div className="pt-3 border-t border-ink-800 flex items-center justify-end gap-2">
          ...
          <button
            type="submit"
            className="px-5 py-2 rounded-xl bg-info-600 hover:bg-info-500 text-white font-bold shadow-lg shadow-info-600/30 flex items-center gap-1.5"
          >
