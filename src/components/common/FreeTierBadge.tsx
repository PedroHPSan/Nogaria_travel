...
export const FreeTierBadge: React.FC = () => {
  ...
  return (
    <div
      ...
      className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-success-500/10 border border-success-500/30 text-[11px] font-medium text-success-300"
    >
      <ShieldCheck className="w-3.5 h-3.5 text-success-400" />
      <span>Free Tier Ativo</span>
      <span className="text-success-400/60 font-mono text-[10px]">
