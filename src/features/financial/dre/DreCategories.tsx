                          ...
                          return (
                            ...
                            >
                              <div className="min-w-0 flex-1">
                                <div className="font-bold text-ink-100 flex items-center gap-2 flex-wrap">
                                  <span className="px-2 py-0.5 rounded bg-ink-800/50 text-[10px] text-ink-300 border border-ink-700">
